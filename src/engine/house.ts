...
const INITIAL_HOUSE: HouseEntrySpec[] = [
  ...
  { path: "lowerdeck/table", kind: "artifact", color: "#a9713f", position: [-0.5, 0.4, 1.6] },
  { path: "lowerdeck/chair", kind: "artifact", color: "#c58a4e", position: [0.55, 0.4, 1.6] },
  { path: "lowerdeck/sofa", kind: "artifact", color: "#7d9d6a", position: [1, 0.4, -1], rotation: [0, -Math.PI / 2, 0] },
  { path: "lowerdeck/tv", kind: "artifact", color: "#3d4654", position: [-1.7, 0.6, -1], rotation: [0, Math.PI / 2, 0] },
  { path: "structural", kind: "component", color: "#6e7480", position: [0, 0, 0] },
  { path: "structural/roof", kind: "artifact", color: "#c94f4f", position: [0, 7.4, 0] },
  { path: "structural/stairs", kind: "artifact", color: "#9c7148", position: [2, 1.5, -1], rotation: [0, Math.PI, 0] },
